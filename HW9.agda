...
zero[T] A Z = ↯
zero[T] A (S m) rewrite zero[T] A m = ↯
...
distr[T/⁘] [] [] = ↯
distr[T/⁘] {A} {n = n₁} (_∷_ {n} x xs) (y ∷ yss) rewrite distr[T/⁘] xs yss = ↯
...
invol[T] A .0 n [] = zero[T] A n
invol[T] A (S m) n (x ∷ xss) with invol[T] A _ n xss
… | IH rewrite distr[T/⁘] x (tr xss) | IH = ↯
