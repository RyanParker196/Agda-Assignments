...
Collaborated on high level ideas about termination issues with DJ
...
cycle-rec ι₀ G σ with σ #[ ι₀ ]
… | I = ⟨ I , σ #[ ι₀ ↦ I ] ⟩
… | O = vec-iter ((G #[ ι₀ ])) ⟨ O , σ #[ ι₀ ↦ I ] ⟩
        (λ where ι O ⟨ xs , S' ⟩ → ⟨ xs , S' ⟩
                 ι I ⟨ xs , S' ⟩ →
                   let ⟨ xs' , S'' ⟩ = cycle-rec ι G S'
                   in ⟨ xs' ⩔ xs , S'' ⟩ )
...
Groups combining previous data structures used in class
Tuples

Minimum Viable Product (MVP): 

Smalles = Verify Euclidean division algorithem
Largest = Prove extra theorems relating to Isomorphisms with Int groups / 
          Dive deeper into group theory and related proofs
